...
import pl.pabilo8.ctmb.common.manual.CTMBManualObject.ManualObjectInfo;
import pl.pabilo8.ctmb.common.manual.objects.*;
...
public class CTMBManualPage extends ManualPages
{
	...
	public static final HashMap<String, BiFunction<ManualObjectInfo, NBTTagCompound, CTMBManualObject>> registeredObjects = new HashMap<>();
