 ...
 * @since 22.05.2022
 */
public class CTMBManualMultiblock extends CTMBManualObject
{
	...
	public CTMBManualMultiblock(ManualObjectInfo info, NBTTagCompound compound)
	{
		super(info, compound);
		String mbName = compound.getString("mb");
